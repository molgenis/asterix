...
public class StarAlleleToPhenotype {
     ...
     * @throws IOException
     */
    private static void writeSampleMatrix(HaplotypeToStarAllele haplotypeToStarAllele, Map<String, Sample> samples) throws IOException{
     ...
     * @throws IOException
     */
    private static void writeSampleMatrixSplitHorizontal(HaplotypeToStarAllele haplotypeToStarAllele, Map<String, Sample> samples) throws  IOException{
        //get the header
     ...
     * @throws IOException
     */
    private static void writeSampleMatrixSplitVertical(HaplotypeToStarAllele haplotypeToStarAllele, Map<String, Sample> samples) throws  IOException{
        //using stringbuilder is more efficient than keep concatenating strings
        StringBuilder stringBuilder = new StringBuilder();
        //go through each sample
        for (Sample sample : samples.values()) {
     ...
     * @throws IOException
     */
    private static void writeSampleMatrixCombined(HaplotypeToStarAllele haplotypeToStarAllele, Map<String, Sample> samples) throws IOException{
